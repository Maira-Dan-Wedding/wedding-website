...
export const FORM_COPY = {
    ...
    instructionsPt: "Preencha, respectivamente, o seu primeiro e último nome completos, com um espaço de separação.", 
    instructionsEn: "Fill out your full first and last name respectively, with one space of separation."
}
...
export const HERO = {
    ...
    height: "80vh",
    position: "bottom",
    filter: "rgba(255, 255, 255, .1), rgba(255, 255, 255, .1)", 
}
